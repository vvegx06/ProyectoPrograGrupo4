 ...
 * @author gaort
 */
public class ConsultarHabitats extends javax.swing.JFrame {

    private String[] datos = new String[4];

    public ConsultarHabitats() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Habitats");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarHabitats.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarHabitats().setVisible(true);
            }
        });
    }
